          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      type="checkbox"
                      className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#00205B] dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-[#00205B] dark:ring-offset-gray-800"
                    />
                  </div>
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-[#00205B] hover:underline dark:text-[#003080]"
                >
                  Forgot password?
                </a>
              </div>
